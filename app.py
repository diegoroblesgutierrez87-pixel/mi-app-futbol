...
def fmt_rapido(r, eq_refs_norm, current_eq_norm, current_eq_orig):
    ...
    try:
        ...
        for ev in eventos.get(fid, []):
            ...
            # filtro minuto = solo minuto en gris, no toda la barra
            color_gol = "#000"
    ...
    return f"<div style='font-family:monospace;font-size:11px;padding:6px 4px;border-bottom:2px solid #333;line-height:1.2;max-width:380px;margin:0 auto'><div style='text-align:center;color:{col};font-weight:900'>|J{j}| {btts_txt}{loc_tag}</div><div style='text-align:center;color:{col};font-weight:900;word-break:break-word'>{extra}</div><div style='display:flex;justify-content:space-between;align-items:center;gap:6px;color:{col};font-weight:900'><span style='text-align:left;flex:1;white-space:nowrap;overflow:hidden;text-overflow:ellipsis'>{hab_u}</span><span style='text-align:center;flex:0 0 auto'>[ {hg}-{ag} ]</span><span style='text-align:right;flex:1;white-space:nowrap;overflow:hidden;text-overflow:ellipsis'>{aab_u}</span></div><div style='display:flex;justify-content:space-between;align-items:center;gap:6px;color:#555;font-weight:700'><span style='text-align:left;flex:1;white-space:nowrap;overflow:hidden;text-overflow:ellipsis'>{hab}</span><span style='text-align:center;flex:0 0 auto'>[ {hthg}-{htag} ]</span><span style='text-align:right;flex:1;white-space:nowrap;overflow:hidden;text-overflow:ellipsis'>{aab}</span></div><div style='color:#000;white-space:normal;word-break:break-word;line-height:1.1'>{txt_mins}</div></div>"
