    ...
    try:
        ...
        for ev in eventos.get(fid, []):
            ...
            if mj == "ON" and gol_ab:
                ...
                html_gol = f'<span style="color:#000; display:inline-block; margin:2px 0">{team_full} | {m}\' |{alterador}{extra_jug}</span>'
            else:
