...
def fmt_rapido(r, eq_refs_norm, current_eq_norm, current_eq_orig):
    ...
    return f"<div style='font-family:monospace;font-size:11px;padding:4px 2px;border-bottom:2px solid #333;line-height:1.35'><span style='color:{col};font-weight:900'>|J{j}| {btts_txt}{loc_tag}</span>{extra}<br><span style='color:{col};font-weight:900'>{hab_u} [ {hg}-{ag} ] {aab_u}</span><br><span style='color:#555;font-weight:700'>{hab} [ {hthg}-{htag} ] {aab}</span><br><span style='color:#000'>| {txt_mins}</span></div>"
