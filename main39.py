...
components.html(
    ...
    // fuerza no-traducir en todos los desplegables
    const style = doc.createElement('style');
    style.innerHTML = '* { translate: no !important; } .notranslate { translate: no !important; }';
...
if modo_vista == "Jornadas":
    ...
    ambos_marcan = c9.selectbox("AmbosMarcan", ["Todos","Sí","No"], key='ambos_marcan')
